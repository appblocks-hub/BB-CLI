...
class HandleTSTemplate {
  /**
   *
   * @param {InitCore} core
   */
  apply(initCore) {
    initCore.hooks.setTemplate.tapPromise('HandleTSTemplate', async (core) => {
      ...
      const templatesPath = path.join(templatesFolder, 'sampleTsTodoTemplate')
...
module.exports = HandleTSTemplate
