...
const setupTemplate = require('./utils/setupTemplate')
...
const setupTsTemplate = require('./utils/setupTsTemplate')
 ...
 */
const init = async (packageName, { typescript, packageOnly }) => {
  let blockLanguage
  ...
  if (useTemplate) {
    ...
    else await setupTemplate(templateOptions)
  }
}
