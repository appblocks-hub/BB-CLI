...
const onPremECRUpload = async (options) => {
  ...
  try {
    console.log("appdata for backend development is \n",appData)
    console.log("env data for backend development is \n",envData)
    console.log("config for backend development is \n",config)
    console.log("deploy config manager for backend development is \n",deployConfigManager)
